...
module "complete" {
  source = alibabacloud-automation/terraform-alicloud-east-west-security-traffic/alicloud
...
| <a name="input_tr_config"></a> [tr\_config](#input\_tr\_config) | The parameters of transit router. | <pre>object({<br>    name                            = optional(string, "east-west-tr")<br>    untrust_route_table_description = optional(string, "untrust")<br>    trust_route_table_description   = optional(string, "trust")<br>  })</pre> | `{}` | no |
